...
def load_verb_lexicons(names: "str | list[str]") -> "GreekInflexion":
    ...
    Course-specific vocabulary lexicons (e.g. the former "odyssey_morpheus")
    live as course-local files in created_with_eee, not here, while the
    course is still under active development — pass the absolute path
    directly instead of a name; see that course's own AGENTS.md.
...
def load_noun_lexicons(names: "str | list[str]") -> "GreekInflexion":
    ...
    Course-specific vocabulary lexicons (e.g. the former "odyssey_morpheus",
    "palaestra_morpheus") live as course-local files in created_with_eee,
    not here, while the course is still under active development — pass
    the absolute path directly instead of a name; see that course's own
    AGENTS.md.
